...
class GithubApi
  ...
  def create_pending_status(repo_name:, commit:, description:, context:)
    create_status(
      repo_name: repo_name,
      sha: commit,
      state: "pending",
  ...
  def create_success_status(repo_name:, commit:, description:, context:)
    create_status(
      repo_name: repo_name,
      sha: commit,
      state: "success",
  ...
  def create_status(repo_name:, sha:, state:, description:, context:)
