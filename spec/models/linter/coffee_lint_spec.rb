...
describe Linter::CoffeeLint do
  include ConfigurationHelper

  describe ".can_lint?" do
    context "given a .coffee file" do
      it "returns true" do
        result = Linter::CoffeeLint.can_lint?("foo.coffee")
    ...
    context "given a .coffee.erb file" do
      it "returns true" do
        result = Linter::CoffeeLint.can_lint?("foo.coffee.erb")
    ...
    context "given a .coffee.js file" do
      it "returns true" do
        result = Linter::CoffeeLint.can_lint?("foo.coffee.js")
    ...
    context "given a non-coffee file" do
      it "returns false" do
        result = Linter::CoffeeLint.can_lint?("foo.js")
  ...
  describe "#file_review" do
    ...
    context "thoughtbot pull request" do
      it "uses the default thoughtbot configuration" do
        spy_on_coffee_lint
        spy_on_file_read
        config_file = thoughtbot_configuration_file(Linter::CoffeeLint)
    ...
    context "non-thoughtbot pull request" do
      it "uses the default hound configuration" do
        spy_on_coffee_lint
        spy_on_file_read
        config_file = default_configuration_file(Linter::CoffeeLint)
